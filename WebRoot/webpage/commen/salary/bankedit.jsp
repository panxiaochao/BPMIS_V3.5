...
var submitForm = function($dialog, $grid, $pjq) {
	var url = "salary/updatebank/bank";		
	var $form = $("#submitform");
...
<div class="div_formbody">
  ...
  <form method="post" name="submitform" id="submitform">
    ...
    <ul class="forminfo">
       <li>
	      <label>银行名字</label>
	      <input class="easyui-textbox" name="bankname" value="${requestScope.pojo.bankname}"  data-options="prompt:'填写银行名字...',required:true" style="width:345px;height:34px">
	      <i><b>*</b>不能超过30个字符</i>
	    </li>
	    <li>
	      <label>银行KEY</label>
	      <input class="easyui-textbox" name="banktype" value="${requestScope.pojo.banktype}"  data-options="prompt:'填写对应银行KEY标识符...',required:true" style="width:345px;height:34px">
	      <i><b>*</b>不能超过30个字符</i>
	    </li>       
    </ul>
  </form>
