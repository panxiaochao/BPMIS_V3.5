...
var addFun = function() {
	var dialog = parent.ext.modalDialog({
		title : '添加银行卡种类信息',
		url : 'system/to/commen_salary_bankadd',
		buttons : [{
			text : '&nbsp;添加&nbsp;',
			handler : function() {
...
var banktype = function(value,rowData,rowIndex) {
	return "<span style=color:#aa6708><b>"+value+"</b></span>";
}
</script>
</head>
...
<div data-options="region:'center'" border="false" style="padding:10px 0;" >
  <table id="tt" style=" border-bottom:none;">
    <thead>
      <tr>
        <th data-options="field:'bankname',width:180">银行卡名称</th>
        <th data-options="field:'banktype',width:100" formatter="banktype">归属</th>     
      </tr>
    </thead>
  </table>
