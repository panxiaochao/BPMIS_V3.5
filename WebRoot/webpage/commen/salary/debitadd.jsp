...
<div class="div_formbody">
  ...
  <form method="post" name="submitform" id="submitform">
    ...
    <ul class="forminfo">
       ...
       <li>
	      <label>借款人</label>
	      <input class="easyui-textbox" name="debituser"  data-options="prompt:'填写借款人...',required:true" style="width:345px;height:34px" />
	      <i><b>*</b>必须填写</i>
	    </li>      
	    <li>
	      <label>借款时间</label>
	      <input id="dd" type="text" name="debittime" style="width:345px;height:34px" required="true" />
	      <script>
			$('#dd').datebox({    
    	...
    	<li>
	      <label>借款说明</label>
	      <input class="easyui-textbox" name="debitsummary" data-options="multiline:true,required:true" value="" style="width:345px;height:100px" />
	    </li>    	       
    </ul>
  </form>
</div>
