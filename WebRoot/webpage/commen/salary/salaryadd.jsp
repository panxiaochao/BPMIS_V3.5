...
$(function(){	
	...
	var combobox = $('#trdetype').combobox({  
		 panelHeight:'auto',
		 valueField:'id',
		 textField:'text',
	     onSelect: function(rowData){
            var url = 'salary/sorttype/'+rowData.id;    
            $('#sortId').combobox('reload', url);    
         }
	});	
	combobox.combobox('loadData', datatype);
})
  ...
  <form method="post" name="submitform" id="submitform">
    ...
    <ul class="forminfo">
       <li>
	    ...
	    <li>
      	  <label>收入方式</label>	     
	      <input class="easyui-combobox" id="trdetype" name="trdetype" style="width:345px;height:34px" required="true"/>  
	    </li>
	    <li>
	      <label>交易类别</label>
	      <input class="easyui-combobox" name=sortId id="sortId" style="width:345px;height:34px" required="true"
				data-options="
						method:'get',
						valueField:'id',
						textField:'text',
	    ...
	    <li>
	      <label>支付方式</label>
	      <input class="easyui-combobox" name="bank" id="bank" style="width:345px;height:34px" required="true"
				data-options="
						url:'salary/salarybank/null',
						method:'get',
						valueField:'id',
						textField:'text',
						panelHeight:120
	    ...
	    <li>
	      <label>交易时间</label>
	      <input id="dd" type="text" name="tradetime" style="width:345px;height:34px" required="true" />
	      <script>
			$('#dd').datebox({    
    	...
    	<li>
	      <label>交易说明</label>
	      <input class="easyui-textbox" name="summary" data-options="multiline:true" value="" style="width:345px;height:100px" />
	    </li>    	       
    </ul>
  </form>
</div>
