...
<div class="div_formbody">
  ...
  <ul class="forminfo">
    <li>
      <label>类别名字</label>
      <input class="easyui-textbox" name="sortname"  data-options="prompt:'填写类别名字...',required:true" style="width:345px;height:34px">
      <i><b>*</b>不能超过30个字符</i>
    </li>
    <li>
      <label>类别方式</label>
      <select class="easyui-combobox" name="sorttype" style="width:345px;height:34px" >
